...
export const routes: Routes = [
    {
        path: '',
        loadComponent: () =>
            import('./layouts/main-layouts/main-layouts').then(
                (m) => m.MainLayouts
            ),
        title: 'inicio',
        ...
        children: [
            ...
            },
            {
                path: 'pasarela',
                loadComponent: () =>
                    import('./features/pasarela/pasarela').then((m) => m.Pasarela),
                title: 'pasarela',
            },
            {
                path: 'mis-pedidos',
                loadComponent: () =>
                    import('./features/pedidos/pedidos').then((m) => m.PedidosComponent),
                title: 'Mis pedidos',
            },
        ],
    },
